...
namespace Project1st.Game.DataBase
{
    public class DB
    {
        ...
        public void PutData()
        {
            ...
            database.Add(24, new Items(24, 2, "반지", 100, 1, 1));
            database.Add(25, new Items(25, 2, "귀걸이", 60, 1, 1));
            database.Add(26, new Items(26, 2, "망원경", 200, 1, 2));
            database.Add(27, new Items(27, 2, "용비늘", 400, 1, 3));
            database.Add(28, new Items(28, 2, "초콜렛", 15, 1, 1));
            database.Add(29, new Items(29, 2, "사탕", 10, 1, 1));
            ...
            database.Add(35, new Items(35, 2, "구슬", 100, 1, 2));
            database.Add(36, new Items(36, 2, "우산", 50, 1, 4));
            database.Add(37, new Items(37, 2, "석탄", 123, 1, 2));
            database.Add(38, new Items(38, 2, "노트", 10, 1, 1));
            database.Add(39, new Items(39, 2, "철광석", 100, 1, 10));
            database.Add(40, new Items(40, 2, "생선", 40, 1, 2));
            database.Add(41, new Items(41, 2, "붓", 10, 1, 1));
